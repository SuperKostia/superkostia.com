...
- `public/projets/coupe-du-monde-dim/dashboard.html` : artefact single-file autonome qui interroge l'API publique ESPN (gratuite, CORS ouverte, sans clé) côté navigateur et affiche en direct les matchs déjà notifiés / en cours / à venir, avec drapeaux et noms en français. DA brutaliste propre au dashboard, auto-actualisation toutes les 60 s. Règle 0 € respectée.
